...
2. Download through User Login
    ...
    * In case your sporify account is linked with your facebook account. Then you can find your username just near your profile image on top `nav bar`. (It will look like some wired text, for eg. `21bidmx2qwnllmviu3z2blt4q`)           
### TODO
